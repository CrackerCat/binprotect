...
const binwrite::mnemonic_t binwrite::mnemonic_t::movsb = mnemonic_t(ZYDIS_MNEMONIC_MOVSB);
const binwrite::mnemonic_t binwrite::mnemonic_t::cpuid_ = mnemonic_t(ZYDIS_MNEMONIC_CPUID);
